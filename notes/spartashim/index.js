...
exports["main_helloWorld"] = createForwarder("/main.helloWorld");
exports["Custom_goAWS_SESLambdaEventSourceResource"] = createForwarder("/Custom::goAWS::SESLambdaEventSourceResource");
exports["Custom_goAWS_S3LambdaEventSourceResource"] = createForwarder("/Custom::goAWS::S3LambdaEventSourceResource");
exports["Custom_goAWS_SNSLambdaEventSourceResource"] = createForwarder("/Custom::goAWS::SNSLambdaEventSourceResource");
exports["Custom_goAWS_CloudWatchLogsLambdaEventSourceResource"] = createForwarder("/Custom::goAWS::CloudWatchLogsLambdaEventSourceResource");
exports["Custom_goAWS_ZipToS3BucketResource"] = createForwarder("/Custom::goAWS::ZipToS3BucketResource");

SPARTA_BINARY_NAME='MyHelloWorldStack.lambda.amd64';
SPARTA_SERVICE_NAME='MyHelloWorldStack';
